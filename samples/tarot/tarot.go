...
func (t *tarot) doSendCard() {
	...
	case 0:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, mainX, mainY, cardWidth, cardHeight))
	case 1:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, mainX+50, mainY, cardWidth, cardHeight)) //TODO rotate..
	case 2:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, mainX-cardWidth-50, mainY, cardWidth, cardHeight))
	case 3:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, mainX+cardWidth+75, mainY, cardWidth, cardHeight))
	case 4:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, mainX, mainY+cardHeight+10, cardWidth, cardHeight))
	case 5:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, mainX, mainY-cardHeight-10, cardWidth, cardHeight))
	case 6:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, rightX, rightY, cardWidth, cardHeight))
	case 7:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, rightX, rightY-cardHeight-10, cardWidth, cardHeight))
	case 8:
		t.drawEvent.AddImageLayer(bus.NewImageLayer(displayCard, rightX, rightY-(2*cardHeight)-20, cardWidth, cardHeight))
	}
	t.bus.SendDrawEvent(t.drawEvent)
